...
// Consulta principal: publicaciones aprobadas
...
foreach ($publicaciones as $pub) {
    ...
    $imagenes = array_map(function($img) {
        return 'http://10.40.22.186/UTEPSA-Eventos/server/src/' . $img;
    }, $imagenes);
    ...
    if ($id_usuario) {
        ...
        $stmt_user_like = $db->prepare($sql_user_like);
